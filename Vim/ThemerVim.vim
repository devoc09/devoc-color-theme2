  ...
  let s:guishade0 = "#1c2036"
  let s:guishade1 = "#314053"
  let s:guishade2 = "#47606f"
  let s:guishade3 = "#5c808c"
  let s:guishade4 = "#729fa9"
  let s:guishade5 = "#87bfc6"
  let s:guishade6 = "#9ddfe2"
  let s:guishade7 = "#b2ffff"
  let s:guiaccent0 = "#ff2400"
  let s:guiaccent1 = "#aac6cf"
  let s:guiaccent2 = "#ff0f4b"
  let s:guiaccent3 = "#ffffaa"
  let s:guiaccent4 = "#ee9393"
  let s:guiaccent5 = "#0e82ff"
  let s:guiaccent6 = "#7f8cff"
  let s:guiaccent7 = "#ffc0cd"
  ...
  let s:ctermshade7 = 159
  let s:ctermaccent0 = 202
  let s:ctermaccent1 = 152
  let s:ctermaccent2 = 197
  let s:ctermaccent3 = 229
  let s:ctermaccent4 = 217
  let s:ctermaccent5 = 39
  let s:ctermaccent6 = 111
  let s:ctermaccent7 = 224
